Public Class RoomChangeCalculator

    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'Get Today's date from the system and displays it.
        lblDateToday.Text = Now.ToString("D")

        'Get the current time from the system and displays it.
        lblTimeToday.Text = Now.ToString("T")
    End Sub

    Private Sub btnCalculate_Click(sender As Object, e As EventArgs) Handles btnCalculate.Click
        ' Declare variables for the calculations.
        Dim decRoomCharges As Decimal       ' Rooms charges total
